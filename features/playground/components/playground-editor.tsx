...
import { useMonacoCollab } from "@/features/collaboration/hooks/useMonacoCollab"
...
export const PlaygroundEditor = ({
  ...
  // Real-time collaboration: bind the active file to a shared Yjs doc.
  const [collabEditor, setCollabEditor] = useState<any>(null)
  useMonacoCollab(collabEditor, activeFilePath ?? null)
  ...
  const handleEditorDidMount = (editor: any, monaco: Monaco) => {
    ...
    // Note: editor.addCommand returns a command-id string, not a disposable
    ...
    // Expose editor/monaco to the parent for AI "Insert into editor"
