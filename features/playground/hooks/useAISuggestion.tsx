...
export const useAISuggestions = (): UseAISuggestionsReturn => {
  ...
  // Keep a ref mirror of the latest state so callbacks can read fresh values
  // without needing to perform side effects inside setState updaters.
  ...
  const acceptSuggestion = useCallback((editor: any, monaco: any) => {
    ...
    // Side effects run here (in the event handler), NOT inside a setState updater.
    editor.executeEdits("", [
      {
